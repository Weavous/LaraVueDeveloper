      ...
      <div class="relative sm:max-w-sm w-full">
        ...
        <div class="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md">
          ...
          <form method="#" action="#" class="mt-10">
            <div>
              <input type="email" placeholder="Inform your e-mail" class="pl-5 mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
            </div>

            <div class="mt-7">
              <input type="password" placeholder="Inform your password" class="pl-5 mt-1 block w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">
            </div>
            ...
            <div class="flex mt-7 justify-around w-full">
              <button class="bg-blue-500 border-none px-4 py-2 rounded-xl cursor-pointer text-white shadow-xl hover:shadow-inner transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105">
                Facebook
              </button>
